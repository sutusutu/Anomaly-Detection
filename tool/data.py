...
from tool.sparse2coarse import sparse2coarse
...
def load_data(opt):
    ...
    if opt.dataset in ['cifar10']:
        ...
        dataset = {}
        dataset['train'] = CIFAR100(root='./data', train=True, download=True, transform=transform)
        dataset['test'] = CIFAR100(root='./data', train=False, download=True, transform=transform)
        dataset['train'].targets = sparse2coarse(dataset['train'].targets)
        dataset['test'].targets = sparse2coarse(dataset['test'].targets)
